...
Rectangle{
    ...
    ColumnLayout {
        ...
        RightButton {
            ...
            onClick: {
                ...
                pageLoader.showLoaderInfo();
                pageLoader.getBottomRectArray();
               //updateParams()
            }
        }
        RightButton {
    ...
    Keys.onPressed:{
        ...
        case Qt.Key_F1:
            console.info("-----------------------------");
            console.info("                 ");
            console.info(root+"!!!!!!AnalyzeMode.qml收到C_FREQUENCY_CHANNEL信号!!!!!");

            Com.clearTopPage(root);
            analyzeMenu.focus=true;
            analyzeMenu.state="SHOW";

            console.info("----AnalyzeMode.qml响应 ◇分析参数◇ 完毕----");
            console.info("                 ");
            console.info("------------------ ----------- ");
            event.accepted=true;
            break;
        case Qt.Key_F5:
            console.info("-----------------------------");
            console.info("                 ");
            console.info(root+"!!!!!!AnalyzeMode.qml收到C_SPAN_X_SCALE!!!!!");
            //记录上一个焦点转移的页面
            idScopeView.focusPageOfrightControl=root;
            ...
            if(idScopeView.whichTypePageOfEle.noCheckbuttonEleArray[0])
            {
                ...
                console.info("----AnalyzeMode.qml响应 ◇C_SPAN_X_SCALE◇ 完毕----");
            }
            else
            {
                console.info("#####AnalyzeMode.qml 图谱不存在！无法响应X轴缩放######");
        ...
        case Qt.Key_F9:
            console.info("-----------------------------");
            console.info("                 ");
            console.info(root+"!!!!!!AnalyzeMode.qml收到C_AMPLITUDE_Y_SCALE!!!!!");
            idScopeView.focusPageOfrightControl=root;
            //idScopeView.getPeakAndmarkEle();//必须调用此函数，whichTypePageOfEle才会有值
            if(idScopeView.whichTypePageOfEle.noCheckbuttonEleArray[0])
            {
                ...
                console.info("----AnalyzeMode.qml响应 ◇C_AMPLITUDE_Y_SCALE◇ 完毕----");
            }
            else
            {
                console.info("#####AnalyzeMode.qml 图谱不存在！无法响应Y轴缩放######");
                console.info(idScopeView.whichTypePageOfEle.noCheckbuttonEleArray[0]);
            }
            console.info("                 ");
            console.info("------------------ ----------- ");
        ...
        case Qt.Key_F15:
            ...
            console.info("-----------------------------");
            console.info("                 ");
            console.info(root+"!!!!!!AnalyzeMode.qml收到C_MARKER!!!!!");
            console.info("                 ");
            console.info("------------------ ----------- ");
            ////////////////////////
            idScopeView.focusPageOfrightControl=root;
            ...
            //////////////////////
            console.info("----AnalyzeMode.qml响应  ◇C_MARKER◇  完毕----");
            event.accepted=true;
            break;
            //case Qt.Key_F3:
        case Qt.Key_F16:
            console.info("-----------------------------");
            console.info("                 ");
            console.info(root+"!!!!!!AnalyzeMode.qml收到C_PEAK_SEARCH!!!!!");
            idScopeView.focusPageOfrightControl=root;
            ...
            console.info("----AnalyzeMode.qml响应  ◇C_PEAK_SEARCH◇   完毕----");
            console.info("                 ");
            console.info("------------------ ----------- ");
            event.accepted=true;
            break;
        ...
        case Qt.Key_F13:
            ...
            console.info("●●●●●● AnalyzeMode.qml 呼出菜单按钮触发●●●●●●idBottomPannel.menuBtn"+idBottomPannel.menuBtn);
            event.accepted=true;
            break;
        ...
        case Qt.Key_F10:
            ...
            console.info("●●●●●● AnalyzeMode.qml 模式切换按钮触发●●●●●●idBottomPannel.modeSwitch"+idBottomPannel.modeSwitch);
            event.accepted=true;
            break;
        ...
        case Qt.Key_F19:
            ...
            console.info("●●●●●● AnalyzeMode.qml 参数更新按钮触发●●●●●●Com.paramsUpdate"+idBottomPannel.paramsUpdate);
            console.info("----AnalyzeMode.qml响应 ◇C_PRESET◇ 完毕----");
            event.accepted=true;
            break;
        default:
            break;
