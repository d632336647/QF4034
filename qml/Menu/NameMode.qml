...
Rectangle{
    ...
    Keys.onPressed:{
        ...
        globalConsoleInfo("#####NameMode.qml收到按键消息#####"+event.key);
        switch(event.key)
        {
        case Qt.Key_Escape:
            //btn_exit.click()
        ...
        case Qt.Key_F1:
            console.info("-----------------------------");
            console.info("                 ");
            console.info(root+"!!!!!!NameMode.qml收到C_FREQUENCY_CHANNEL信号!!!!!");

            Com.clearTopPage(root);
            analyzeMenu.focus=true;
            analyzeMenu.state="SHOW";

            console.info("----NameMode.qml响应 ◇分析参数◇ 完毕----");
            console.info("                 ");
            console.info("------------------ ----------- ");
            event.accepted=true;
            break;
        case Qt.Key_F5:
            console.info("-----------------------------");
            console.info("                 ");
            console.info(root+"!!!!!!NameMode.qml收到C_SPAN_X_SCALE!!!!!");
            //记录上一个焦点转移的页面
            ...
            if(idScopeView.whichTypePageOfEle.noCheckbuttonEleArray[0])
            {
                ...
                console.info("----NameMode.qml响应 ◇C_SPAN_X_SCALE◇ 完毕----");
            }
            else
            {
                console.info("#####NameMode.qml 图谱不存在！无法响应X轴缩放######");
        ...
        case Qt.Key_F9:
            ...
            if(idScopeView.whichTypePageOfEle.noCheckbuttonEleArray[0])
            {
                ...
                console.info("----NameMode.qml响应 ◇C_AMPLITUDE_Y_SCALE◇ 完毕----");
            }
            else
            {
                console.info("#####NameMode.qml 图谱不存在！无法响应Y轴缩放######");
                console.info(idScopeView.whichTypePageOfEle.noCheckbuttonEleArray[0]);
            }
            console.info("                 ");
            console.info("------------------ ----------- ");
        ...
        case Qt.Key_F15:
            ...
            console.info("-----------------------------");
            console.info("                 ");
            console.info(root+"!!!!!!NameMode.qml收到C_MARKER!!!!!");
            console.info("                 ");
            console.info("------------------ ----------- ");
            ////////////////////////
            idScopeView.focusPageOfrightControl=root;
            ...
            //////////////////////
            console.info("----NameMode.qml响应  ◇C_MARKER◇  完毕----");
            event.accepted=true;
            break;
            //case Qt.Key_F3:
        case Qt.Key_F16:
            console.info("-----------------------------");
            console.info("                 ");
            console.info(root+"!!!!!!NameMode.qml收到C_PEAK_SEARCH!!!!!");
            idScopeView.focusPageOfrightControl=root;
            ...
            console.info("----NameMode.qml响应  ◇C_PEAK_SEARCH◇   完毕----");
            console.info("                 ");
            console.info("------------------ ----------- ");
            event.accepted=true;
            break;
        ...
        case Qt.Key_F13:
            ...
            console.info("●●●●●●NameMode.qml  呼出菜单按钮触发●●●●●●idBottomPannel.menuBtn"+idBottomPannel.menuBtn);
            event.accepted=true;
            break;
        ...
        case Qt.Key_F10:
            ...
            console.info("●●●●●●NameMode.qml  模式切换按钮触发●●●●●●idBottomPannel.modeSwitch"+idBottomPannel.modeSwitch);
            event.accepted=true;
            break;
        ...
        case Qt.Key_F19:
            ...
            console.info("●●●●●●NameMode.qml  参数更新按钮触发●●●●●●Com.paramsUpdate"+idBottomPannel.paramsUpdate);
            console.info("---NameMode.qml响应 ◇C_PRESET◇ 完毕----");
            event.accepted=true;
            break;
    ...
    states: [
        State {
            ...
            onCompleted:{
                ...
                globalConsoleInfo("                                    ");
                globalConsoleInfo("                                    ");
                globalConsoleInfo("☆☆☆☆NameMode.qml获得焦点☆☆☆☆");
                globalConsoleInfo("                                    ");
                globalConsoleInfo("                                    ");
                //传递获得焦点的页面元素
                idScopeView.focusPageOfrightControl=root;
